...
proc create_hier_cell_icmp { parentCell nameHier } {
  ...
  set icmpMyIpAddressNet [get_bd_pins icmp_server/myIpAddress]
  if {$icmpMyIpAddressNet == "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2090 -severity "Warning" "Unable to find pins of icmp_server/myIpAddress, using icmp_server/myIpAddress_0_0_0 instead (for Vitis 2022.2)."}
     connect_bd_net -net interface_settings_0_my_ip_address [get_bd_pins myIpAddress] [get_bd_pins icmp_server/myIpAddress_0_0_0]
  } else {
